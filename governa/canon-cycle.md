...
2. **Application — pure-canon files.** Whole-file overwrite from canon. Typical examples: `cmd/rel/main.go`, `governa/roles.md`, `governa/ac-template.md`, `governa/README.md`.
