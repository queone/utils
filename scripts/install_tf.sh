#!/usr/bin/env bash
# install_tf.sh 1.4.0
# Install or upgrade Terraform: Homebrew on a Mac, HashiCorp's apt repository on Debian or Ubuntu, the official archive otherwise
...
usage() {
    ...
    printf "Usage: install_tf.sh [-n] [-a] [VERSION]\n"
