...
- [`vclip`](cmd/vclip/README.md): Keep a section of a video — extract START..END to a new file — via ffmpeg.
- [`vcut`](cmd/vcut/README.md): Remove a section of a video — cut START..END and join the remainder — via ffmpeg.
